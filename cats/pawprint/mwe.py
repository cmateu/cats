...
#Plot the track 
ax.plot(pawprint.track.ra, pawprint.track.dec, '.', ms=2., color='C0')
#plot the default polygon track stored in the library 
ax.plot(pawprint.skyprint['stream'].icrs.ra, pawprint.skyprint['stream'].icrs.dec, ls='--', color='C0')
...
ax.plot(pawprint.skyprint['background'].icrs.ra, pawprint.skyprint['background'].icrs.dec, ls=':', color='C1')
